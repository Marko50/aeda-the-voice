...
void titulo() {
	...
	cout << " |________     ________| " << "               " << " \\\\                // " << "               " << "_" << endl;
	cout << "         ||   ||  " << "           " << "   _________" << " \\\\              //  " << " ___________  " << "|_| " << " ___________" << "   _________" << endl;
	cout << "         ||   ||  " << "||       ||" << " ||_________" << "  \\\\            //   " << "| _________ |  " << "   " << "| __________" << " ||_________" << endl;
	cout << "         ||   ||  " << "||       ||" << " ||         " << "   \\\\          //    " << "||         ||  " << "|| " << "||          " << " ||         " << endl;
	cout << "         ||   ||  " << "||_______||" << " ||______   " << "    \\\\        //     " << "||         ||  " << "|| " << "||          " << " ||______   " << endl;
	cout << "         ||   ||  " << "||_______||" << " ||______   " << "     \\\\      //      " << "||         ||  " << "|| " << "||          " << " ||______   " << endl;
	cout << "         ||   ||  " << "||       ||" << " ||         " << "      \\\\    //       " << "||         ||  " << "|| " << "||          " << " ||         " << endl;
	cout << "         ||   ||  " << "||       ||" << " ||_________" << "       \\\\  //        " << "||_________||  " << "|| " << "||__________" << " ||_________" << endl;
	cout << "         ||   ||  " << "||       ||" << " ||_________" << "        \\\\//         " << "|___________|  " << "|| " << "|___________" << " ||_________" << endl;
}